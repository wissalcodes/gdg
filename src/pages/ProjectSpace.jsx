...
const ProjectSpace = () => {
  ...
  return (
    <div className="relative bg-white w-full h-[100vh] text-left text-xl text-black font-product-sans ">
      <div className="absolute top-[796px] left-[248px] rounded-2xl bg-white shadow-[0px_-49px_14px_rgba(214,_214,_214,_0),_0px_-31px_12px_rgba(214,_214,_214,_0.01),_0px_-18px_11px_rgba(214,_214,_214,_0.05),_0px_-8px_8px_rgba(214,_214,_214,_0.09),_0px_-2px_4px_rgba(214,_214,_214,_0.1)] w-[1022px] h-[284px]" />
      <ProjectNameSpace />
      <DashboardContainer />
      ...
      <div className="absolute top-[427px] left-[930px] rounded-lg bg-blue w-[277px] h-[46px] flex flex-row items-center justify-center p-5 box-border text-center text-white">
      ...
      />
      <CheckpointsForm />
      <div className="absolute top-[877px] left-[266px] flex flex-row items-end justify-start gap-[24px]">
        <ReportProjectContainer />
      </div>
      <img
        className="absolute h-[1.3%] w-[1.2%] top-[75.37%] right-[59.79%] bottom-[23.33%] left-[39.01%] max-w-full overflow-hidden max-h-full"
        alt=""
        src="/icon1.svg"
      />
      <img
        className="absolute h-[1.3%] w-[1.2%] top-[76.3%] right-[59.79%] bottom-[22.41%] left-[39.01%] max-w-full overflow-hidden max-h-full"
        alt=""
        src="/icon1.svg"
      />
      <div className="absolute top-[796px] left-[298px] flex flex-row items-center justify-center p-2.5 text-center text-13xl">
