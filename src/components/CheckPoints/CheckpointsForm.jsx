...
const CheckpointsForm = () => {
  ...
  return (
    <div className="absolute top-[154px] left-[1294px] rounded-2xl bg-whitesmoke w-[584px] h-[877px] overflow-hidden text-left text-5xl text-black font-product-sans ">
